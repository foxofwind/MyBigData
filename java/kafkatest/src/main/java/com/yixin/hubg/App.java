...
public class App {
    ...
    public static final String OUTPUT_TOPIC = "fa_apply_info_ext_dw";

    static Properties getStreamsConfig() {
        final Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "fa_apply_info_ext"); //groupId
        props.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, "10.0.4.98:9092,10.0.4.99:9092,10.0.4.100:9092");
